...
우선 __1단계!__ <BR/>
![이미지](https://user-images.githubusercontent.com/50163676/88367199-20755300-cdc6-11ea-9b95-6d4398701fe5.png "C 함수 알고리즘 01")<BR/>(a의 p가 가리키는 녀석의 n이 b를 가리키도록 변경한다.)<BR/>
![이미지](https://user-images.githubusercontent.com/50163676/88366410-0fc3dd80-cdc4-11ea-96d6-384b0fc35894.jpeg "C 함수 알고리즘 02")<BR/>(b의 p가 가리키는 녀석의 n이 a를 가리키도록 변경한다.)<BR/>
![이미지](https://user-images.githubusercontent.com/50163676/88366412-12263780-cdc4-11ea-92ed-1e5b75f4d118.jpeg "C 함수 알고리즘 03")<BR/>(a의 n이 가리키는 녀석의 p가 b를 가리키도록 변경한다.)<BR/>
![이미지](https://user-images.githubusercontent.com/50163676/88366414-13effb00-cdc4-11ea-9d02-0d7a64d703b5.jpeg "C 함수 알고리즘 04")<BR/>(b의 n이 가리키는 녀석의 p가 a를 가리키도록 변경한다.)<BR/>
__여기까지 변경한 후에 그림을 보기 좋게 다듬어 보자.__ <BR/>
![이미지](https://user-images.githubusercontent.com/50163676/88366418-15b9be80-cdc4-11ea-8005-01aaa0727089.jpeg "중간 단계")<BR/>
![이미지](https://user-images.githubusercontent.com/50163676/88366414-13effb00-cdc4-11ea-9d02-0d7a64d703b5.jpeg "C 함수 알고리즘 05")<BR/>(b의 n이 가리키는 녀석의 p가 a를 가리키도록 변경한다.)<BR/>
![이미지](https://user-images.githubusercontent.com/50163676/88366422-18b4af00-cdc4-11ea-98f8-8417f33a7da4.jpeg "중간 단계")<BR/>('a의 p가 가리키는 녀석'을 b의 p가 가리키도록 변경한다.)<BR/>
다시 시작한다. 어느덧 5단계까지 왔다. <BR/>
![이미지](https://user-images.githubusercontent.com/50163676/88366424-1a7e7280-cdc4-11ea-89bf-0d575a94adcd.jpeg "C 함수 알고리즘 06")<BR/>('a의 p가 가리키는 녀석'을 a의 n이 가리키도록 변경한다.)<BR/>
![이미지](https://user-images.githubusercontent.com/50163676/88366431-1ce0cc80-cdc4-11ea-9b4c-494b5db4f696.jpeg "C 함수 알고리즘 07")<BR/>('a의 n이 가리키는 녀석'을 b의 n이 가리키도록 변경한다.)<BR/>
...
__여기까지 마치면 최종 완성인 줄 착각할 수 있다. 중요한 것이 있다. 어느 코딩에서나 중요한, '예외 처리'다.__
<BR/> __처음 1단계부터 4단계까지의 부분에서 노드 a와 b가 각각 연결 리스트 끄트머리의 노드인 경우 예외사항을 추가해 주니 문제 없이 컴파일되었다!__ 코드 화면을 참고하시라.<BR/>
